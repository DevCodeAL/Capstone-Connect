            ...
            <ul className="flex justify-evenly items-center text-base sm:text-lg md:text-xl lg:text-2xl font-bold">
              <li className="flex justify-start">
                <Link to="/index" className="text-green-400">
                 ...
                 <a href="#index-sections" className={isActive('/index')}>Home</a>
               </li>
         
              <li className="text-sm sm:text-base md:text-lg">
                <a href="#project-sections" className={isActive('/about')}>Browse Project</a>
              </li>
              
              <li className="text-sm sm:text-base md:text-lg">
               <a href="#about-section" className={isActive('/about-section')}>About</a>
              </li>
...
{/* Project Sections */}
<section className="bg-gray-50 py-16" id='project-sections'>
  {/* <!-- Container --> */}
  <div className="max-w-7xl mx-auto px-6">
    {/* <!-- Title --> */}
